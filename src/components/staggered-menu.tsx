    ...
    <div className={`sm-scope z-50 ${isFixed ? 'fixed top-0 left-0 w-full h-full' : 'relative w-full h-full'}`}>
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-white/80 flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
